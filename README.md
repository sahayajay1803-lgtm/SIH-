...
In another terminal, load Qwen into the Ollama container: `docker compose exec ollama ollama pull qwen2.5:7b`. Set `OLLAMA_BASE_URL=http://ollama:11434` in `.env` when running the API in Compose.
